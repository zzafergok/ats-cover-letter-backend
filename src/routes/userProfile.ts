...
router.post(
  '/experience',
  authenticateToken,
  userProfileController.addExperience
);
router.put(
  '/experience/:id',
  authenticateToken,
...
router.put(
  '/course/:id',
  authenticateToken,
  userProfileController.updateCourse
);
router.delete(
  '/course/:id',
  authenticateToken,
  userProfileController.deleteCourse
);
...
router.post(
  '/certificate',
  authenticateToken,
  userProfileController.addCertificate
);
router.put(
  '/certificate/:id',
  authenticateToken,
  userProfileController.updateCertificate
);
router.delete(
  '/certificate/:id',
  authenticateToken,
  userProfileController.deleteCertificate
);
...
router.delete(
  '/hobby/:id',
  authenticateToken,
  userProfileController.deleteHobby
);
